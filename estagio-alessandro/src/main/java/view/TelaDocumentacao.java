...
public class TelaDocumentacao extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaDocumentacao frame = new TelaDocumentacao();
	...
	public TelaDocumentacao() {
		...
		JLabel lblDocumento1 = new JLabel("Documento 1");
		lblDocumento1.setBounds(22, 45, 100, 14);
